...
@section('header', 'Foydalanuvchi: ' . $user->name)
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Ro'yxatdan o'tgan: {{ $user->created_at->format('d.m.Y H:i') }}
                    </p>
                </div>
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-gray-500">Mijoz: {{ $ticket->customer->name }}</p>
                                </div>
                                <div class="ml-4">
                                    @php
                                        $statusColors = [
                    ...
                    @else
                    <p class="text-gray-500 text-center py-8">Bu foydalanuvchida hali zayavkalar yo'q</p>
                    @endif
                </div>
            </div>
        </div>
